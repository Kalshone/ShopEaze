...
public class StoreProductDetailsFragment extends Fragment {
    ...
    public static StoreProductDetailsFragment newInstance(String productID) {
        StoreProductDetailsFragment fragment = new StoreProductDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_store_product_details, container, false);
